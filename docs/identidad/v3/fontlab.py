...
def axes_of(name):
    """Ejes variables disponibles en la fuente. Archivo, tal como lo sirve el
    sitio, solo trae el de peso: sin 'wdth' hay que justificar con tracking."""
    f, _ = load(name)
    return {a.axisTag for a in f['fvar'].axes} if 'fvar' in f else set()
